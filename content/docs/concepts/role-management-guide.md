...
**TL;DR:**
- Roles live in the database, assignments live in claims
- Use global vs app-specific roles based on scope
- Assign roles via dashboard, server actions, or SQL
- Enforce roles in middleware, server components, and RLS

**Time to read:** 25 minutes | **Prerequisites:** [Claims Guide](/docs/claims-guide) | **Next steps:** [Role Frontend Patterns](/docs/role-frontend-patterns)
...
For React/Next.js hooks, gates, and UI patterns, see **[Role Frontend Patterns](/docs/role-frontend-patterns)**.
...
For complete, copy-paste examples, see **[Role Management Examples](/docs/role-examples)**.
...
- **Admin types:** [Admin Types and Permissions](/docs/admin-types)
- **UI patterns:** [Role Frontend Patterns](/docs/role-frontend-patterns)
- **Examples:** [Role Management Examples](/docs/role-examples)
- **Database security:** [RLS Policies](/docs/rls-policies)
