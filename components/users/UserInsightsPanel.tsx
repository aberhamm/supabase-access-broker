...
export function UserInsightsPanel({
  ...
  const engagementFactors = [
    lastSignInDays <= 7 ? 30 : lastSignInDays <= 30 ? 15 : 0, // Activity
    hasMFA ? 25 : 0, // Security
    emailVerified ? 15 : 0, // Verification
    claimsCount * 5, // Claims (max 30)
    appsCount * 10, // Apps (max 30)
  ];
